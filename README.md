...
I help companies turn commercial complexity into revenue clarity — designing the systems, data architecture, and go-to-market motions that connect product, sales, marketing, and customer success into a single operating model.

Currently building a **RevOps infrastructure platform** for LatAm startups, using Claude Code, Python, and n8n to package enterprise-grade revenue operations tooling at startup-accessible cost.
